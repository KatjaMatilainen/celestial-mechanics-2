...
;use the fourier transf. function
	...
	window,11
	plot,res.period/(2*!dpi),res.amplitude,xlog=1,ylog=1,psym=0, $
		xra=[1d-4,50],yra=[1d-6,1d-1],yst=1, $
